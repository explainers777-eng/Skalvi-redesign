      ...
      <div className="container-shell">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {achievements.map((item) => (
            <article key={`${item.title}-${item.category}`} className="group overflow-hidden rounded-[8px] border border-skalvi-purple/10 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-soft">
